...
setInterval(() => client.user.setActivity({ name: `${config.status} - VirtueWizard#4814 ${Number(client?.shard?.ids)+1 ? Number(client?.shard?.ids)+1 : ""}`, type: ActivityType.Listening }), 10000);
